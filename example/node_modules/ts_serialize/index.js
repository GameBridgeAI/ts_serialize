...
exports.recursiveToJson = exports.defaultToJson = exports.fromJsonAs = exports
  .ISODateFromJson = exports.createDateStrategy = exports.composeStrategy =
    exports.ToJsonStrategy = exports.FromJsonStrategy = exports.Serializable =
      exports.SerializeProperty = void 0;
...
(function () {
  ...
  function _dI() {
    _dI = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee(mid, src) {
        var id,
          _id$split$reverse,
          _id$split$reverse2,
          o,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _id$split$reverse = id.split("/").reverse(),
                  _id$split$reverse2 = _toArray(_id$split$reverse),
                  o = _id$split$reverse2[0],
                  ia = _id$split$reverse2.slice(1),
                  _src$split$reverse = src.split("/").reverse(),
                  _src$split$reverse2 = _toArray(_src$split$reverse),
                  sa = _src$split$reverse2.slice(1),
                  oa = [o];
                s = 0;
              ...
              case 16:
                if (s < sa.length) {
                  oa.push.apply(oa, _toConsumableArray(sa.slice(s)));
                }
                id = oa.reverse().join("/");
              ...
              case 18:
                return _context.abrupt(
                  ...
                  r.has(id)
                    ? gExpA(id)
                    : Promise.resolve("".concat(mid)).then(function (s) {
        ...
        SerializePropertyOptionsMap = /*#__PURE__*/ function () {
          ...
          _createClass(SerializePropertyOptionsMap, [{
            ...
            value: function set(serializePropertyOptions) {
              ...
              if (
                this.serializedKeyMap.has(
                  serializePropertyOptions.serializedKey,
                )
              ) {
                throw new Error(
                  "".concat(ERROR_MESSAGE_DUPLICATE_SERIALIZE_KEY, ": ").concat(
                    serializePropertyOptions.serializedKey,
                  ),
                );
              }
              ...
              if (
                this.propertyKeyMap.has(serializePropertyOptions.propertyKey)
              ) {
                throw new Error(
                  "".concat(ERROR_MESSAGE_DUPLICATE_PROPERTY_KEY, ": ").concat(
                    serializePropertyOptions.propertyKey.toString(),
                  ),
                );
              }
              ...
              var parentSerializedObject =
                (_this$parentMap = this.parentMap) === null ||
                  _this$parentMap === void 0
                  ? void 0
                  : _this$parentMap.getBySerializedKey(
                    serializePropertyOptions.serializedKey,
                  );
              ...
              if (
                ...
                this.propertyKeyIgnoreSet.add(
                  parentSerializedObject.propertyKey,
                );
              }

              var parentPropertyObject =
                (_this$parentMap2 = this.parentMap) === null ||
                  _this$parentMap2 === void 0
                  ? void 0
                  : _this$parentMap2.getByPropertyKey(
                    serializePropertyOptions.propertyKey,
                  );
            ...
            value: function hasPropertyKey(propertyKey) {
              ...
              return this.propertyKeyMap.has(propertyKey) ||
                !this.propertyKeyIgnoreSet.has(propertyKey) &&
                  ((_this$parentMap3 = this.parentMap) === null ||
                      _this$parentMap3 === void 0
                    ? void 0
                    : _this$parentMap3.hasPropertyKey(propertyKey)) ||
                false;
            },
          }, {
            ...
            value: function getByPropertyKey(propertyKey) {
              ...
              return this.propertyKeyMap.get(propertyKey) ||
                !this.propertyKeyIgnoreSet.has(propertyKey) &&
                  ((_this$parentMap4 = this.parentMap) === null ||
                      _this$parentMap4 === void 0
                    ? void 0
                    : _this$parentMap4.getByPropertyKey(propertyKey)) ||
                undefined;
            },
          }, {
            ...
            value: function hasSerializedKey(serializedKey) {
              ...
              return this.serializedKeyMap.has(serializedKey) ||
                !this.serializedKeyIgnoreSet.has(serializedKey) &&
                  ((_this$parentMap5 = this.parentMap) === null ||
                      _this$parentMap5 === void 0
                    ? void 0
                    : _this$parentMap5.hasSerializedKey(serializedKey)) ||
                false;
            },
          }, {
            ...
            value: function getBySerializedKey(serializedKey) {
              ...
              return this.serializedKeyMap.get(serializedKey) ||
                !this.serializedKeyIgnoreSet.has(serializedKey) &&
                  ((_this$parentMap6 = this.parentMap) === null ||
                      _this$parentMap6 === void 0
                    ? void 0
                    : _this$parentMap6.getBySerializedKey(serializedKey)) ||
                undefined;
            },
          }, {
            ...
            value: function getMergedWithParentMap() {
              ...
              var parentEntries = Array.from(
                ((_this$parentMap7 = this.parentMap) === null ||
                    _this$parentMap7 === void 0
                  ? void 0
                  : _this$parentMap7.getMergedWithParentMap()) || [],
              );
              return new Map(
                [].concat(
                  _toConsumableArray(parentEntries.filter(function (e) {
...
System.register(
  ...
  function (exports_4, context_4) {
    ...
    function toPojo(context) {
      ...
      var serializablePropertyMap = SERIALIZABLE_CLASS_MAP.get(
        context === null || context === void 0
          ? void 0
          : (_context$constructor = context.constructor) === null ||
              _context$constructor === void 0
          ? void 0
          : _context$constructor.prototype,
      );
      ...
      if (!serializablePropertyMap) {
        ...
        throw new Error(
          "".concat(ERROR_MESSAGE_MISSING_PROPERTIES_MAP, ": ").concat(
            context === null || context === void 0
              ? void 0
              : (_context$constructor2 = context.constructor) === null ||
                  _context$constructor2 === void 0
              ? void 0
              : _context$constructor2.prototype,
          ),
        );
      }
      ...
      var _iterator2 = _createForOfIteratorHelper(
          serializablePropertyMap.propertyOptions(),
        ),
        _step2;
      ...
      try {
        var _loop = function _loop() {
          ...
          var _step2$value = _step2.value,
            ...
            toJsonStrategy = _step2$value$toJsonSt === void 0
              ? default_to_json_ts_1.defaultToJson
              : _step2$value$toJsonSt;
    ...
    function _fromJson(context, json) {
      ...
      var serializablePropertyMap = SERIALIZABLE_CLASS_MAP.get(
        context === null || context === void 0
          ? void 0
          : (_context$constructor3 = context.constructor) === null ||
              _context$constructor3 === void 0
          ? void 0
          : _context$constructor3.prototype,
      );
      ...
      if (!serializablePropertyMap) {
        ...
        throw new Error(
          "".concat(ERROR_MESSAGE_MISSING_PROPERTIES_MAP, ": ").concat(
            context === null || context === void 0
              ? void 0
              : (_context$constructor4 = context.constructor) === null ||
                  _context$constructor4 === void 0
              ? void 0
              : _context$constructor4.prototype,
          ),
        );
      }
      ...
      return Object.assign(
        context,
        JSON.parse(_json, function revive(key, value) {
          if (key === "") {
            return value;
          }
          ...
          var _ref2 = serializablePropertyMap.getBySerializedKey(key) || {},
            ...
            fromJsonStrategy = _ref2$fromJsonStrateg === void 0
              ? function (v) {
                return v;
              }
              : _ref2$fromJsonStrateg;

          var processedValue = Array.isArray(value)
    ...
    return {
      ...
      execute: function execute() {
        SerializePropertyOptions = function SerializePropertyOptions(
          propertyKey,
          serializedKey,
          fromJsonStrategy,
          toJsonStrategy,
          ...
          if (Array.isArray(fromJsonStrategy)) {
            this.fromJsonStrategy = composeStrategy.apply(
              void 0,
              _toConsumableArray(fromJsonStrategy),
            );
          ...
          if (Array.isArray(toJsonStrategy)) {
            this.toJsonStrategy = composeStrategy.apply(
              void 0,
              _toConsumableArray(toJsonStrategy),
            );
        ...
        Serializable = /*#__PURE__*/ function () {
          ...
          _createClass(Serializable, [{
            ...
            value: function fromJson() {
              var json = arguments.length > 0 && arguments[0] !== undefined
                ? arguments[0]
                : {};
  ...
  function (exports_5, context_5) {
    ...
    function SerializeProperty() {
      ...
      return function (target, propertyName) {
        ...
        var serializablePropertiesMap = serializable_ts_2.SERIALIZABLE_CLASS_MAP
          .get(target);

        if (!serializablePropertiesMap) {
          var parentMap = serializable_ts_2.SERIALIZABLE_CLASS_MAP.get(
